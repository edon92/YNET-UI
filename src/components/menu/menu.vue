  ...
  export default {
    ...
    render (h) {
      const component = (
        <ul
          ...
          class={{
            'yn-menu--horizontal': this.mode === 'horizontal',
            'yn-menu--collapse': this.collapse,
            "yn-menu": true
          }}
        >
          { this.$slots.default }
        ...
        render(createElement, context) {
          const data = {
            ...
            on: {
              ...
              enter(el) {
                addClass(el, 'yn-opacity-transition');
                el.style.opacity = 1;
              },

              afterEnter(el) {
                removeClass(el, 'yn-opacity-transition');
                el.style.opacity = '';
              },
              ...
              beforeLeave(el) {
                ...
                if (hasClass(el, 'yn-menu--collapse')) {
                  removeClass(el, 'yn-menu--collapse');
                  el.dataset.oldOverflow = el.style.overflow;
                  el.dataset.scrollWidth = el.clientWidth;
                  addClass(el, 'yn-menu--collapse');
                } else {
                  addClass(el, 'yn-menu--collapse');
                  el.dataset.oldOverflow = el.style.overflow;
                  el.dataset.scrollWidth = el.clientWidth;
    ...
    watch: {
      ...
      collapse(value) {
        ...
        this.broadcast('YnSubmenu', 'toggle-collapse', value);
      }
    },
    methods: {
