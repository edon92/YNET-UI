<template>
  <div
    ...
    :class="[
      'yn-input-number',
      inputNumberSize ? 'yn-input-number--' + inputNumberSize : '',
      { 'is-disabled': inputNumberDisabled },
      { 'is-without-controls': !controls },
      { 'is-controls-right': controlsAtRight }
    ]">
    <span
      class="yn-input-number__decrease"
      role="button"
      v-if="controls"
      v-repeat-click="decrease"
      :class="{'is-disabled': minDisabled}"
      @keydown.enter="decrease">
      <i :class="`yn-icon-${controlsAtRight ? 'arrow-down' : 'minus'}`"></i>
    </span>
    <span
      class="yn-input-number__increase"
      role="button"
      v-if="controls"
      v-repeat-click="increase"
      :class="{'is-disabled': maxDisabled}"
      @keydown.enter="increase">
      <i :class="`yn-icon-${controlsAtRight ? 'arrow-up' : 'plus'}`"></i>
    </span>
    <yn-input
      ref="input"
      :value="displayValue"
...
<script>
  import YnInput from '../input/input';
